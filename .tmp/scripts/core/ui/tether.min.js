  ...
  function i(t, e) {
    ...
    if ("undefined" != typeof t.classList) e.split(" ").forEach(function (e) {
      ...
      var o = new RegExp("(^| )" + e.split(" ").join("|") + "( |$)", "gi"),
          i = p(t).replace(o, " ");u(t, i);
    }
  }function l(t, e) {
    if ("undefined" != typeof t.classList) e.split(" ").forEach(function (e) {
      e.trim() && t.classList.add(e);
    });else {
      h(t, e);var o = p(t) + (" " + e);u(t, o);
    }
  }function d(t, e) {
    if ("undefined" != typeof t.classList) return t.classList.contains(e);var o = p(t);return new RegExp("(^| )" + e + "( |$)", "gi").test(o);
  }function p(t) {
    ...
    var o = t.left,
      ...
      H = function H(t) {
    var e = t.left,
        o = t.top;return "undefined" != typeof F[t.left] && (e = F[t.left]), "undefined" != typeof F[t.top] && (o = F[t.top]), { left: e, top: o };
  },
      X = function X(t) {
    var e = t.split(" "),
        o = M(e, 2),
        ...
        var t = this,
          ...
          this.clearCache();var o = Y(this.targetAttachment, this.attachment);this.updateAttachClasses(this.attachment, o);var i = this.cache("element-bounds", function () {
            ...
            return t.getTargetBounds();
              ...
              g = y(this.targetOffset, d);p = v(p, c), u = v(u, g);for (var m = l.left + u.left - p.left, b = l.top + u.top - p.top, w = 0; w < C.modules.length; ++w) {
            var O = C.modules[w],
                E = O.position.call(this, { left: m, top: b, targetAttachment: o, targetPos: l, elementPos: i, offset: p, targetOffset: u, manualOffset: c, manualTargetOffset: g, scrollbarSize: A, attachment: this.attachment });if (E === !1) return !1;"undefined" != typeof E && "object" == (typeof E === "undefined" ? "undefined" : _typeof(E)) && (b = E.top, m = E.left);
    ...
    function t(t, e) {
      ...
      var e = this,
        ...
        var e = f[t];e !== o && e !== h || d.push(t);
          ...
          u = [],
          g = ["left", "top", "right", "bottom"];return p.push(this.getClass("abutted")), g.forEach(function (t) {
